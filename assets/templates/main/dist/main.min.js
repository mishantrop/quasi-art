...
/***/ "./assets/templates/main/js/src/backtotop.ts":
/*!***************************************************!*\
  !*** ./assets/templates/main/js/src/backtotop.ts ***!
  \***************************************************/
...
/* harmony export */   "initBackToTopScroll": function() { return /* binding */ initBackToTopScroll; }
/* harmony export */ });
/* harmony import */ var scroll_to_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! scroll-to-element */ "./node_modules/scroll-to-element/index.js");
/* harmony import */ var scroll_to_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(scroll_to_element__WEBPACK_IMPORTED_MODULE_0__);

var initBackToTopScroll = function initBackToTopScroll(_ref) {
  var targetSelector = _ref.targetSelector;
  var backToTopSelector = '.back-to-top';
  var backToTopClassActive = 'back-to-top--active';
  var scrollTrigger = 300;
  var backToTop = document.querySelector(backToTopSelector);
  ...
  if (backToTop) {
    ...
    var el = document.querySelector(targetSelector) || false;

    if (el) {
      backToTop.addEventListener('click', function () {
        scroll_to_element__WEBPACK_IMPORTED_MODULE_0___default()(targetSelector);
      });
    } else {
...
/***/ "./assets/templates/main/js/src/helpers.ts":
/*!*************************************************!*\
  !*** ./assets/templates/main/js/src/helpers.ts ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./assets/templates/main/js/src/lightbox.ts":
/*!**************************************************!*\
  !*** ./assets/templates/main/js/src/lightbox.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var initLightbox = function initLightbox() {
  return new luminous_lightbox__WEBPACK_IMPORTED_MODULE_0__.LuminousGallery(document.querySelectorAll('.fancybox-thumbs'), {});
};

/***/ }),

/***/ "./assets/templates/main/js/src/navigation.ts":
/*!****************************************************!*\
  !*** ./assets/templates/main/js/src/navigation.ts ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./helpers */ "./assets/templates/main/js/src/helpers.ts");
...
var Navigation = /*#__PURE__*/function () {
  function Navigation() {
    ...
    this.state = void 0;
    this.menuNav = void 0;
    this.menuToggler = void 0;
    this.iconClosed = void 0;
    this.iconOpened = void 0;
    this.navbarTogglerIcon = void 0;
  }

  _createClass(Navigation, [{
    key: "setState",
    value: function setState(patch) {
      this.state = _objectSpread(_objectSpread({}, this.state), patch);
      this.render();
    }
  }, {
    key: "init",
    value: function init() {
      ...
      window.addEventListener('resize', function () {
        var isMobileScreen = _this.isMobileScreen();

        _this.setState({
          isMobile: isMobileScreen,
          isOpened: isMobileScreen ? false : _this.state.isOpened
        });
    ...
    value: function isMobileScreen() {
      return (0,_helpers__WEBPACK_IMPORTED_MODULE_7__.isMobile)();
    }
  }, {
    key: "render",
...
/***/ "./assets/templates/main/js/src/resume.ts":
/*!************************************************!*\
  !*** ./assets/templates/main/js/src/resume.ts ***!
  \************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initResume": function() { return /* binding */ initResume; }
/* harmony export */ });
/* harmony import */ var scroll_to_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! scroll-to-element */ "./node_modules/scroll-to-element/index.js");
/* harmony import */ var scroll_to_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(scroll_to_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _superbutton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./superbutton */ "./assets/templates/main/js/src/superbutton.ts");


var initResume = function initResume() {
  var buttonWrite = document.getElementById('resume-header__write');
  ...
  buttonWrite.addEventListener('click', function (event) {
    var targetSelector = buttonWrite.getAttribute('data-target');
  ...
  buttonWrite.addEventListener('mousemove', _superbutton__WEBPACK_IMPORTED_MODULE_1__.superbutton);
};

/***/ }),

/***/ "./assets/templates/main/js/src/sameheight.ts":
/*!****************************************************!*\
  !*** ./assets/templates/main/js/src/sameheight.ts ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "sameHeight": function() { return /* binding */ sameHeight; }
/* harmony export */ });
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers */ "./assets/templates/main/js/src/helpers.ts");



var sameHeight = function sameHeight(selector) {
  var elements = document.querySelectorAll(selector);
  elements.forEach(function (element) {
    element.style.height = 'auto';
  });

  if ((0,_helpers__WEBPACK_IMPORTED_MODULE_2__.isMobile)()) {
    elements.forEach(function (element) {
      element.style.height = 'auto';
    });
  } else {
...
/***/ "./assets/templates/main/js/src/superbutton.ts":
/*!*****************************************************!*\
  !*** ./assets/templates/main/js/src/superbutton.ts ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "superbutton": function() { return /* binding */ superbutton; }
/* harmony export */ });
/* eslint-disable semi */
var superbutton = function superbutton(event) {
  var x = event.pageX - event.target.offsetLeft;
  var y = event.pageY - event.target.offsetTop;
  event.target.style.setProperty('--x', "".concat(x, "px"));
  event.target.style.setProperty('--y', "".concat(y - 60, "px"));
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ php; }
/* harmony export */ });
/*
Language: PHP
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ typescript; }
/* harmony export */ });
const IDENT_RE = '[A-Za-z$_][0-9A-Za-z$_]*';
const KEYWORDS = [
  "as", // for exports
...
"use strict";
/*!***********************************************!*\
  !*** ./assets/templates/main/js/src/index.ts ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var highlight_js_lib_languages_typescript__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! highlight.js/lib/languages/typescript */ "./node_modules/highlight.js/es/languages/typescript.js");
...
/* harmony import */ var highlight_js_lib_languages_php__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! highlight.js/lib/languages/php */ "./node_modules/highlight.js/es/languages/php.js");
...
/* harmony import */ var _backtotop__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./backtotop */ "./assets/templates/main/js/src/backtotop.ts");
/* harmony import */ var _lightbox__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./lightbox */ "./assets/templates/main/js/src/lightbox.ts");
/* harmony import */ var _sameheight__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./sameheight */ "./assets/templates/main/js/src/sameheight.ts");
/* harmony import */ var _resume__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./resume */ "./assets/templates/main/js/src/resume.ts");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./helpers */ "./assets/templates/main/js/src/helpers.ts");
/* harmony import */ var _navigation__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./navigation */ "./assets/templates/main/js/src/navigation.ts");
/* eslint-disable @typescript-eslint/ban-ts-comment */
...
var sameHeightWithResize = function sameHeightWithResize(selector) {
  (0,_sameheight__WEBPACK_IMPORTED_MODULE_8__.sameHeight)(selector);
  window.addEventListener('resize', function () {
    var ww = (0,_helpers__WEBPACK_IMPORTED_MODULE_10__.getWindowWidth)(); // @ts-ignore
...
var init = function init() {
  detectAdBlock();
  (0,_resume__WEBPACK_IMPORTED_MODULE_9__.initResume)();
  (0,_backtotop__WEBPACK_IMPORTED_MODULE_6__.initBackToTopScroll)({
    targetSelector: '.menu'
  });
  var navigation = new _navigation__WEBPACK_IMPORTED_MODULE_11__.Navigation();
  navigation.init(); // Главная страница / Работы портфолио

  sameHeightWithResize('.portfolio-item__info-title'); // Портфолио / Работа / Галерея

  var portfolioContainer = document.querySelector('.portfoilo-inner-item__images-wrapper');

  if (portfolioContainer) {
    // @ts-ignore
    imagesloaded__WEBPACK_IMPORTED_MODULE_5___default()(portfolioContainer, function () {
  ...
  (0,_lightbox__WEBPACK_IMPORTED_MODULE_7__.initLightbox)();
  ...
  highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0__["default"].registerLanguage('typescript', highlight_js_lib_languages_typescript__WEBPACK_IMPORTED_MODULE_2__["default"]);
  highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0__["default"].registerLanguage('css', highlight_js_lib_languages_css__WEBPACK_IMPORTED_MODULE_3__["default"]);
  highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0__["default"].registerLanguage('php', highlight_js_lib_languages_php__WEBPACK_IMPORTED_MODULE_4__["default"]);
  highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0__["default"].initHighlightingOnLoad();
  var contactsFormOptions = {
    hideFormOnSuccess: false,
    selector: '#contacts-form-wrapper',
    callbackOnSuccess: function callbackOnSuccess(data) {
      console.log('callbackOnSuccess');
      console.log(data);
      var messagesWrapper = document.querySelector('[data-quasiform="messages"]');
    ...
    callbackOnFail: function callbackOnFail(data) {
  ...
  if ('quasiform' in window) {
    ...
    var contactsForm = new window.quasiform.Quasiform(contactsFormOptions);
  }
};
